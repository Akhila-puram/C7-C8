...
import com.aaseya.MDM.OMSConstant;
import com.aaseya.MDM.dto.AccessToken;

import com.aaseya.MDM.dto.TaskVariables;
...
//	}
	...
	public String CompleteTaskByIDReview(String id, Map<String, Object> variables) {
	    String uri = OMSConstant.BASE_TASK_URL + id + OMSConstant.COMPLETE_URL;
	    ResponseEntity<String> response = null;
	    logger.info("Complete Variables: " + variables);
	    ...
	    try {
	        ...
	        String requestJson;
	        if (variables.containsKey("reviewStatus") && variables.containsKey("reinspection")) {
	            requestJson = "{\"variables\": [{\"name\": \"reviewStatus\",\"value\": " + variables.get("reviewStatus") +
	                         "},{\"name\": \"reinspection\",\"value\": " + variables.get("reinspection") + "}]}";
	        } else if (variables.containsKey("reviewStatus")) {
	            requestJson = "{\"variables\": [{\"name\": \"reviewStatus\",\"value\": " + variables.get("reviewStatus") + "}]}";
	        } else if (variables.containsKey("approved") && variables.containsKey("reinspection")) {
	            requestJson = "{\"variables\": [{\"name\": \"approved\",\"value\": " + variables.get("approved") +
	                         "},{\"name\": \"reinspection\",\"value\": " + variables.get("reinspection") + "}]}";
	        } else if (variables.containsKey("approved")) {
	            requestJson = "{\"variables\": [{\"name\": \"approved\",\"value\": " + variables.get("approved") + "}]}";
	        } else {
